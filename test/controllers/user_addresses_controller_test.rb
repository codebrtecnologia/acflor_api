...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference("UserAddress.count") do
      post user_addresses_url, params: { user_address: { city: @user_address.city, neighborhood: @user_address.neighborhood, street: @user_address.street, user_id: @user_address.user_id, zip_code: @user_address.zip_code } }, as: :json
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: { user_address: { city: @user_address.city, neighborhood: @user_address.neighborhood, street: @user_address.street, user_id: @user_address.user_id, zip_code: @user_address.zip_code } }, as: :json
    assert_response :success
  end
